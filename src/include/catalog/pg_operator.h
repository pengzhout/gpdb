...
DATA(insert OID = 5988 (  "="	   PGNSP PGUID b t f 2249 2249 16 5988 5989 record_eq eqsel eqjoinsel ));
DATA(insert OID = 5989 (  "<>"	   PGNSP PGUID b f f 2249 2249 16 5989 5988 record_ne neqsel neqjoinsel ));
DATA(insert OID = 5990 (  "<"	   PGNSP PGUID b f f 2249 2249 16 5991 5993 record_lt scalarltsel scalarltjoinsel ));
DATA(insert OID = 5991 (  ">"	   PGNSP PGUID b f f 2249 2249 16 5990 5992 record_gt scalargtsel scalargtjoinsel ));
DATA(insert OID = 5992 (  "<="	   PGNSP PGUID b f f 2249 2249 16 5993 5991 record_le scalarltsel scalarltjoinsel ));
DATA(insert OID = 5993 (  ">="	   PGNSP PGUID b f f 2249 2249 16 5992 5990 record_ge scalargtsel scalargtjoinsel ));
