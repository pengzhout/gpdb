...
/* record comparison */
DATA(insert OID = 5981 (  record_eq		   PGNSP PGUID 12 1 0 f f t f i 2 16 "2249 2249" _null_ _null_ _null_ record_eq _null_ _null_ _null_ ));
DESCR("record equal");
DATA(insert OID = 5982 (  record_ne		   PGNSP PGUID 12 1 0 f f t f i 2 16 "2249 2249" _null_ _null_ _null_ record_ne _null_ _null_ _null_ ));
DESCR("record not equal");
DATA(insert OID = 5983 (  record_lt		   PGNSP PGUID 12 1 0 f f t f i 2 16 "2249 2249" _null_ _null_ _null_ record_lt _null_ _null_ _null_ ));
DESCR("record less than");
DATA(insert OID = 5984 (  record_gt		   PGNSP PGUID 12 1 0 f f t f i 2 16 "2249 2249" _null_ _null_ _null_ record_gt _null_ _null_ _null_ ));
DESCR("record greater than");
DATA(insert OID = 5985 (  record_le		   PGNSP PGUID 12 1 0 f f t f i 2 16 "2249 2249" _null_ _null_ _null_ record_le _null_ _null_ _null_ ));
DESCR("record less than or equal");
DATA(insert OID = 5986 (  record_ge		   PGNSP PGUID 12 1 0 f f t f i 2 16 "2249 2249" _null_ _null_ _null_ record_ge _null_ _null_ _null_ ));
DESCR("record greater than or equal");
DATA(insert OID = 5987 (  btrecordcmp	   PGNSP PGUID 12 1 0 f f t f i 2 23 "2249 2249" _null_ _null_ _null_ btrecordcmp _null_ _null_ _null_ ));
DESCR("btree less-equal-greater");
