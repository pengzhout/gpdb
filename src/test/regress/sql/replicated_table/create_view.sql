...
CREATE TABLE viewtest_tbl (a int, b int) distributed fully;
...
CREATE SCHEMA temp_view_test
    CREATE TABLE base_table (a int, id int) distributed fully
    CREATE TABLE base_table2 (a int, id int);

SET search_path TO temp_view_test, public;

CREATE TEMPORARY TABLE temp_table (a int, id int) distributed fully;
