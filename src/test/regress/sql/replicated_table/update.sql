...
CREATE TABLE tab1 (a varchar(15), b integer) DISTRIBUTED fully;
...
CREATE TABLE tab1 (a text, b integer) DISTRIBUTED FULLY;
...
CREATE TABLE tab1 (a varchar, b integer) DISTRIBUTED FULLY;
CREATE TABLE tab2 (a varchar, b integer) DISTRIBUTED FULLY;
...
CREATE TABLE tab2 (a char(15), b integer) DISTRIBUTED FULLY;

UPDATE tab1 SET b = tab2.b FROM tab2 WHERE tab1.a = tab2.a;

DROP TABLE IF EXISTS update_distr_key; 

CREATE TABLE update_distr_key (a int, b int) DISTRIBUTED FULLY; 
