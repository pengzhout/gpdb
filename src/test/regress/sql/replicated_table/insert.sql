...
--
create table inserttest (col1 int4, col2 int4 NOT NULL, col3 text default 'testing') distributed fully;
...
create table bar(x int) distributed fully;        
create table foo(like bar) distributed fully;
...
create table bar(x int, y int) distributed fully;        
create table foo(like bar) distributed fully;
