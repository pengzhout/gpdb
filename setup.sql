...
update gp_distribution_policy set regionname = 'region1' from pg_class where gp_distribution_policy.localoid = pg_class.oid and pg_class.relname = 'test';
...
update gp_distribution_policy set regionid = 2 from pg_class where gp_distribution_policy.localoid = pg_class.oid and pg_class.relname = 'test1';
update gp_distribution_policy set regionname = 'region2' from pg_class where gp_distribution_policy.localoid = pg_class.oid and pg_class.relname = 'test1';
